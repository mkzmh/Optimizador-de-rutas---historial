...
# --- Funciones Auxiliares para Navegación (RE-INTRODUCIDAS) ---
...
if page == "Calcular Nueva Ruta":
        ...
        with st.spinner('Realizando cálculo óptimo y agrupando rutas'):
            try:
                ...
                if "error" in results:
                    ...
                    if 'geojson_link' not in results['ruta_a']: 
                        results['ruta_a']['geojson_link'] = 'https://geojson.io/'
                    ...
                    if 'geojson_link' not in results['ruta_b']: 
                        results['ruta_b']['geojson_link'] = 'https://geojson.io/'
    ...
    if st.session_state.results:
        ...
        with col_a:
            ...
            # Si 'geojson_link' no existe, o no es un link completo, usamos el fallback.
            ...
            with col_btn_a_5:
                # El enlace forzado a GeoJSON.io se usa aquí
